...
surv = pd.read_csv('survival-withSmoking.csv')

parameters = ["IMPACT_TMB_SCORE", "PACK-YEAR_HISTORY", "AGE", "CLINICALLY_REPORTED_PD-L1_SCORE", "ALBUMIN", "DNLR", "EGFR_DRIVER"]

surv = surv[parameters + ['PFS_MONTHS', 'PFS_STATUS']]

# Drop those with low variance
run_model(surv, 'MSK MIND LUAD - RSF Selected Parameters (with Smoking)')