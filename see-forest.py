...
surv.drop(columns=columns_to_drop, inplace=True)
...
covariates = ['AGE', 'ALBUMIN', 'CLINICALLY_REPORTED_PD-L1_SCORE', 'DNLR', 'ECOG',
       'EGFR_DRIVER', 'ERBB2_DRIVER', 'FRACTION_GENOME_ALTERED',
       'IMPACT_TMB_SCORE', 'IS_FEMALE', 'MSI_SCORE', 'PACK-YEAR_HISTORY',
       'STK11_DRIVER']
...
if len(G.nodes) == 0:
    ...
    net.save_graph('rsf_tree_visualization.html')