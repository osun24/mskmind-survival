...
rankedParameters = ["IMPACT_TMB_SCORE", "ALBUMIN", "DNLR", "PACK-YEAR_HISTORY", "CLINICALLY_REPORTED_PD-L1_SCORE","EGFR_DRIVER","AGE", "ECOG", "ERBB2_DRIVER", "MSI_SCORE", "STK11_DRIVER", "IS_FEMALE", "FRACTION_GENOME_ALTERED"]
...
plt.title('Concordance Index by Inclusion of Parameters for RSF')
plt.grid()
plt.savefig('cph-c-index-over-rsf-parameters.png')
plt.show()
