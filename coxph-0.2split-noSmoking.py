...
surv.drop(columns = ["PEMBROLIZUMAB", "ATEZOLIZUMAB", "NIVOLUMAB", "PACK-YEAR_HISTORY", "CURRENT_SMOKER", "FORMER_SMOKER", "NEVER_SMOKER"], inplace = True)

n = len(surv)

# Drop those with low variance
run_model(surv, 'ALL without SMOKING - MSK MIND LUAD, n = ' + str(n))